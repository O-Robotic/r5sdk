...
typedef union tagSQObjectValue
{
	...
	float fFloat;
	void* pUserPointer;
	struct SQFunctionProtoUnimplemented* pUnimplementedFunction;
...
inline SQChar* ( *v_sq_printobjvalue )( struct SQObjectPtr* pObj );
...
class VSquirrelAPI : public IDetour
{
	virtual void GetAdr(void) const
	{
		...
		LogFunAdr( "sq_printobjvalue", v_sq_printobjvalue );
	...
	virtual void GetFun(void) const
	{
		...
		Module_FindPattern( g_GameDll, "48 83 EC ?? 83 39 ?? 4C 8B C9" ).GetPtr( v_sq_printobjvalue );
